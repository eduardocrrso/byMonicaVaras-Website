        ...
        <div className="flex gap-12 sm:hidden">
            <Popover>
                ...
                <PopoverPanel
                    transition
                    anchor="bottom"
                    className="p-4 divide-y divide-white/5 rounded-sm bg-background transition duration-500 ease-in-out [--anchor-gap:var(--spacing-5)] data-[closed]:-translate-y-1 data-[closed]:opacity-0"
                >
                    {links.map((link) => {
                        return (
                            <div className={clsx(
